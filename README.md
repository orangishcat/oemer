...
***SPECIAL MENTION*** of [homr](https://github.com/liebharc/homr), an awesome improved version of this project by [Christian Liebhardt](https://github.com/liebharc), features a more dedicated and powerful deep learning model, ffering greater robustness to image quality, and producing more pleasing final results.
